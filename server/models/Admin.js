...
const adminUserSchema = new mongoose.Schema(
  {
    ...
    role: {
      type: String,
      enum: ["superadmin", "orgadmin", "projectadmin"],
      default: "orgadmin",
    },
    ...
    permissions: {
      ...
      canManageSystemSettings: { type: Boolean, default: false }, // only superadmin
      canRunBackups: { type: Boolean, default: false },
      canWhitelistIPs: { type: Boolean, default: false },
    },
